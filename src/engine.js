...
const DOMAINS_RAW = [
  {
    ...
    questions: [
      ...
      { id: "f12", checkin: true, text: "I sense God is calling our family to something significant we have not yet fully embraced.", type: T.AGREEMENT, w: 8.56,
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "m4", checkin: true,  text: "I am satisfied with the quality and quantity of time we spend together.",                   type: T.SATISFACTION,
        info: "Quantity and quality of shared time — the raw material of the 'emotional bank account.'" },
      { id: "m5", checkin: true,  text: "We share a clear, agreed-upon vision for our marriage.",                                     type: T.CLARITY,
      ...
      { id: "m16", checkin: true, text: "We actively help each other grow into the people God is calling us to become.",              type: T.AGREEMENT,
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "v3", checkin: true,  text: "I am satisfied with the balance between work and the rest of my life.",                     type: T.SATISFACTION,
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "b7", checkin: true,  text: "I take Sabbath, rest, and renewal seriously as spiritual and physical disciplines.",        type: T.FREQUENCY,
